...
class _BaseWrapper(object):
    ...
    def forward(self, image, get_prob=False, get_feature=False):
        ...
        if get_feature:
            self.logits, out_features = self.model.forward_ms_flip(image, separate=True, get_feature=get_feature)
        else:
            self.logits = self.model.forward_ms_flip(image, separate=True)
